 ...
 * @author DELL
 */
public class TaoPhieuNhapHang extends javax.swing.JFrame {

    /**
     * Creates new form TaoPhieuNhapHang
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("XIN MỜI TẠO PHIẾU NHẬP");

        jButton1.setText("Bắt đầu tạo");
...
new MenuNhanVien().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaoPhieuNhapHang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
