 ...
 * @author DELL
 */
public class TrangDangKy extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TrangDangKy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
